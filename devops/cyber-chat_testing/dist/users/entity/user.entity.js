...
let User = class User {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String }, username: { required: true, type: () => String }, passwordHash: { required: true, type: () => String }, threads: { required: true, type: () => [require("../../threads/entities/thread.entity").Thread] }, comments: { required: true, type: () => [require("../../comments/entities/comment.entity").Comment] } };
    }
};
exports.User = User;
__decorate([
...
__decorate([
    (0, typeorm_1.OneToMany)(() => thread_entity_1.Thread, (thread) => thread.author),
