...
Set up an Express application with TypeScript and Nunjucks. Use the Clean Blog theme from Start Bootstrap as the visual template. Download it from the theme page.
